...
export const MovieHeader = ({ poster, originalTitle, title }: Props) => {
	...
	// por las dudas que se cambie a una pantalla mas grande
	...
	return (
		<>
			...
			<View style={styles.marginContainer}>
				...
				{/* <Text style={styles.title}>{movie.title}</Text> //lo deje modo ejemplo para saber la forma anterior de como lo hicimos */}
